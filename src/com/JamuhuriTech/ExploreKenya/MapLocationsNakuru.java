...
public class MapLocationsNakuru extends UserLocationMap {
	...
	@Override
	 ...
	 nakuru = new GeoPoint((int)(-0.303099*1E6),(int)(36.080026*1E6));
	 mapController.animateTo(nakuru);
	 ...
	 public void onClickShare (View v)
		{
			if (Util.isConnected(MapLocationsNakuru.this)) {
			Intent intent = new Intent(MapLocationsNakuru.this, ExploreKenyaShare.class);
	        startActivity(intent);
			}
			else{
	      		 Toast.makeText(MapLocationsNakuru.this, " No internet Connection Detected", Toast.LENGTH_LONG).show();
	      	}
		}
	 @Override
