...
public class TourismDisplay extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tourism_display);
        ...
        list.setOnItemClickListener(new OnItemClickListener() {
        	public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        		...
        		quickAction_list = new QuickAction(TourismDisplay.this, QuickAction.HORIZONTAL);
        		...
        		quickAction_list.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {			
        			...
        			public void onItemClick(QuickAction source, int pos, int actionId) {				
        				...
        				if (actionId == WEBSITE) {
        					...
        					Intent i =new Intent(TourismDisplay.this,ExploreKenyaWebView.class);
			...
			new fetch(){ 
				public void onPostExecute(JSONObject jArray) {
					if(jArray!=null){
				        ...
				        list=(ListView)findViewById(R.id.list_m);
				        adapter=new LazyAdapter_tourism_display(TourismDisplay.this, searchist);
				        list.setAdapter(adapter);
				        list.setTextFilterEnabled(true);
				        list.setOnItemClickListener(new OnItemClickListener() {
				        	public void onItemClick(AdapterView<?> parent, View view, final int position, long id) { 
				        		
				        		quickAction_list_search = new QuickAction(TourismDisplay.this, QuickAction.HORIZONTAL);
					...
					{
					this.progressDialog.dismiss();
					new AlertDialog.Builder(TourismDisplay.this)
    ...
    AsyncTask<String, Integer, JSONObject> {
		protected ProgressDialog progressDialog = new ProgressDialog(TourismDisplay.this);
	
        protected void onPreExecute() {
		
        	progressDialog.setMessage("Searching "+q_search+" .....");
	         progressDialog.show();
		...
		protected void onProgressUpdate(final Integer... progress) {
			...
			{
			Toast.makeText(TourismDisplay.this, "Network Error.....Try Again Later!", Toast.LENGTH_LONG).show();	
			}
		}
	...
	{
		Intent intent = new Intent(TourismDisplay.this, ExploreKenyaShare.class);
        startActivity(intent);
	}
    public void onClicklogo (View v)
	{
		Toast.makeText(TourismDisplay.this, "ExploreKenya", Toast.LENGTH_LONG).show();
	}
    @Override
