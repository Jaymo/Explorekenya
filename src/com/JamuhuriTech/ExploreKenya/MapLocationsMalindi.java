...
public class MapLocationsMalindi extends UserLocationMap {
	...
	@Override
	 ...
	 malindi = new GeoPoint((int)(-3.219186*1E6),(int)(40.116891*1E6));
	 mapController.animateTo(malindi);
	 ...
	 public void onClickShare (View v)
		{
			if (Util.isConnected(MapLocationsMalindi.this)) {
			Intent intent = new Intent(MapLocationsMalindi.this, ExploreKenyaShare.class);
	        startActivity(intent);
			}
			else{
	      		 Toast.makeText(MapLocationsMalindi.this, " No internet Connection Detected", Toast.LENGTH_LONG).show();
	      	}
		}
	 @Override
