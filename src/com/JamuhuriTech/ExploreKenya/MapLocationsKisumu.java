...
public class MapLocationsKisumu extends UserLocationMap {
	...
	@Override
	 ...
	 kisumu = new GeoPoint((int)(-0.091702*1E6),(int)(34.767957*1E6));
	 mapController.animateTo(kisumu);
	 ...
	 public void onClickShare (View v)
		{
			if (Util.isConnected(MapLocationsKisumu.this)) {
			Intent intent = new Intent(MapLocationsKisumu.this, ExploreKenyaShare.class);
	        startActivity(intent);
			}
			else{
	      		 Toast.makeText(MapLocationsKisumu.this, " No internet Connection Detected", Toast.LENGTH_LONG).show();
	      	}
		}
	 @Override
