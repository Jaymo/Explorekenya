...
public class MapLocations extends UserLocationMap {
	...
	@Override
	 ...
	 nairobi = new GeoPoint((int)(-1.292066*1E6),(int)(36.821946 *1E6));
	 mapController.animateTo(nairobi);
	 ...
	 public void onClickShare (View v)
		{
			if (Util.isConnected(MapLocations.this)) {
			Intent intent = new Intent(MapLocations.this, ExploreKenyaShare.class);
	        startActivity(intent);
			}
			else{
	      		 Toast.makeText(MapLocations.this, " No internet Connection Detected", Toast.LENGTH_LONG).show();
	      	}
		}
	 @Override
