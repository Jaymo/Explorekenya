...
public class MapLocationsMombasa extends UserLocationMap {
	...
	@Override
	 ...
	 mombasa = new GeoPoint((int)(-4.043477*1E6),(int)(39.668207*1E6));
	 mapController.animateTo(mombasa);
	 ...
	 public void onClickShare (View v)
		{
			if (Util.isConnected(MapLocationsMombasa.this)) {
			Intent intent = new Intent(MapLocationsMombasa.this, ExploreKenyaShare.class);
	        startActivity(intent);
			}
			else{
	      		 Toast.makeText(MapLocationsMombasa.this, " No internet Connection Detected", Toast.LENGTH_LONG).show();
	      	}
		}
	 @Override
